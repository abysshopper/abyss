...
The [`provenance/derivative-manifest.json`](provenance/derivative-manifest.json) ledger is the file-level provenance record for the 36 listed derivatives. It records origin identities and modifications; it is not deployed-bytecode verification, a completeness assertion, an audit, or a legal conclusion.
