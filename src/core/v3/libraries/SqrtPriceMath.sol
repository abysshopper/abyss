...
library SqrtPriceMath {
    ...
    function getNextSqrtPriceFromAmount0RoundingUp(
        ...
        if (add) {
            uint256 product;
            unchecked {
                // These operations intentionally wrap solely to detect the same
                // multiplication and denominator overflow as pinned Solidity 0.7.
            ...
            uint256 product;
            unchecked {
                // Wrapping preserves the explicit canonical overflow check below.
                product = amount * sqrtPX96;
            }
            // Product overflow implies denominator underflow; subtraction itself remains checked.
