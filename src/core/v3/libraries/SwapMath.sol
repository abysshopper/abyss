...
// Modified by the Abyss project on 2026-08-17 and 2026-08-18 for the Solidity 0.8.26 port and exact-output domain preservation.
...
library SwapMath {
        ...
        returns (uint160 sqrtRatioNextX96, uint256 amountIn, uint256 amountOut, uint256 feeAmount)
    {
        ...
        if (exactIn) {
            ...
            // Preserve the pinned 0.7 exact-output domain, including type(int256).min.
            amountRemainingAbs = uint256(-(amountRemaining + 1)) + 1;
            ...
            if (amountRemainingAbs >= amountOut) {
                ...
                sqrtRatioNextX96 = SqrtPriceMath.getNextSqrtPriceFromOutput(
                    sqrtRatioCurrentX96, liquidity, amountRemainingAbs, zeroForOne
                );
            }
        }
